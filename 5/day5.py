...
def flight_computer(program):
    ...
    while True:
        ...
        if instruction == "01" or instruction == "1":
            ...
            print([L[pos+1] if opcode_1 == '1' else L[L[pos+1]]][0]) 
            pos += 2
